...
pub fn new(session_container: web::Data <SessionContainer>, user_database: web::Data <UserDatabase>) -> impl FnOnce(&mut ServiceConfig) {
    move |app: &mut web::ServiceConfig| {
        app.service(problem::service())
            ...
            .service(auth::service(session_container, user_database))
