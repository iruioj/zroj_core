...
export type JudgerStatus = (JudgerStatusAccepted|JudgerStatusCompileError|JudgerStatusCustom|JudgerStatusDangerousSyscall|JudgerStatusMemoryLimitExceeded|JudgerStatusOutputLimitExceeded|JudgerStatusPartial|JudgerStatusPresentationError|JudgerStatusRuntimeError|JudgerStatusTimeLimitExceeded|JudgerStatusWrongAnswer);
export type JudgerStatusAccepted = {name:"accepted";payload:null;};
...
export type JudgerStatusPartial = {name:"partial";payload:[number,number];};
...
export type TaskMeta = {memory:Memory;score:number;status:JudgerStatus;time:Elapse;};
